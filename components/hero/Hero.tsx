    ...
    <Container className={classes.hero}>
      <Container className={classes.heroTextWrapper}>
        ...
        <Text className={classes.heroParagraph}>
          Frontend developer living in Fredrikstad. Enjoy creating modern web applications and is
          eager to learn and emprove in both design and programming.
        </Text>
        <Container className={classes.btnContainer}>
          <Anchor href="#about">
            <Button className={classes.btn} variant="outline" color="teal" size="xl" radius="lg">
              About me
            </Button>
          </Anchor>
          <Anchor href="#work">
            <Button className={classes.btn} variant="gradient" size="xl" radius="lg">
              My work
            </Button>
          </Anchor>
        </Container>
